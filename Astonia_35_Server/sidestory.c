...
int ruby_create_item(struct ruby_aston_npc *me)
{
	...
	switch(me->skl) {
		case V_TWOHAND:		sprite=10373; dam=12; flags=IF_TWOHAND|IF_WNTWOHANDED; name="Two-Handed Sword"; desc="two-handed sword"; break;
		case V_SWORD:		sprite=10384; dam=6; flags=IF_SWORD; name="Sword"; desc="sword"; break;
		case V_DAGGER:		sprite=10395; dam=0; flags=IF_DAGGER; name="Dagger"; desc="dagger"; break;
		case V_STAFF:		sprite=10406; dam=4; flags=IF_STAFF|IF_WNTWOHANDED; name="Staff"; desc="staff"; break;
