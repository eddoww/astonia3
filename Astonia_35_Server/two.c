...
void robber_dead(int cn,int co)
{
	...
	if (ppd && ppd->thief_state>=6 && ppd->thief_state<=9) {
                switch(ch[cn].level) {
                        case 33:	ppd->thief_killed[0]++; break;
			case 37:        ppd->thief_killed[1]++; break;
			case 40:	ppd->thief_killed[2]++; break;
			case 44:	ppd->thief_killed[3]++; break;
                        case 48:	ppd->thief_killed[4]++; break;
			case 52:	ppd->thief_killed[5]++; break;
