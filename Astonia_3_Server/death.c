/*
 * $Id: death.c,v 1.13 2008/03/24 11:21:24 devel Exp devel $ (c) D.Brockhaus
 *
 * $Log: death.c,v $
 * Revision 1.13  2008/03/24 11:21:24  devel
 * less exp while lagging
 *
 * Revision 1.12  2007/12/10 10:09:04  devel
 * remove fire on death
 *
 * Revision 1.11  2007/08/13 18:50:38  devel
 * fixed some warnings
 *
 * Revision 1.10  2007/06/22 12:56:18  devel
 * added RWW death to caligar palace
 *
 * Revision 1.9  2007/05/26 13:20:31  devel
 * *** empty log message ***
 *
 * Revision 1.8  2007/05/19 12:17:20  devel
 * made it impossible to give items to dying characters
 *
