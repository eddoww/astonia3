...
$Id: book.c,v 1.1 2005/09/24 09:48:53 ssim Exp $

$Log: book.c,v $
Revision 1.1  2005/09/24 09:48:53  ssim
Initial revision

Revision 1.2  2003/10/13 14:11:50  sam
Added RCS tags
...
void book_driver(int in,int cn)
{
	...
	switch(it[in].drdata[0]) {
		...
		case BOOK_SUPERIOR2:
			log_char(cn,LOG_SYSTEM,0,"Specimen 33. Prototype 4. Keyword: Nazimah.");
		...
		case BOOK_SUPERIOR3:
			log_char(cn,LOG_SYSTEM,0,"Specimen 35. Prototype 4. Keyword: Argatoth.");
		...
		case BOOK_SUPERIOR5:
			log_char(cn,LOG_SYSTEM,0,"Specimen 34. Prototype 4. Keyword: Lorganoth.");
		...
		case BOOK_SUPERIOR6:
			log_char(cn,LOG_SYSTEM,0,"Specimen 36. Prototype 4. Keyword: Markanoth.");
