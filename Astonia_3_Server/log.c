...
$Id: log.c,v 1.2 2007/08/13 18:50:38 devel Exp $
...
Revision 1.4  2004/02/18 11:13:39  sam
restore point

Revision 1.3  2003/11/07 11:42:15  sam
added headers for type of items listed to log_items()
...
/*
log.c (C) 2001 D.Brockhaus

Logfile output. Simple and refreshing. Once things get running smoothly,
we should change the system to write daily logs instead of one huge one.
*/
