/*
 * $Id: drvlib.c,v 1.2 2005/12/14 10:51:25 ssim Exp $ (c) 2005 D.Brockhaus
 *
 * $Log: drvlib.c,v $
...
enum tasktype {freeze,fireball,ball,flash,warcry,attack,moveright,moveleft,moveup,movedown,regenerate,distance3,distance7,bless,earthrain,earthmud,heal,ms,pulse,attackback,flee,firering,maxtasktype};
