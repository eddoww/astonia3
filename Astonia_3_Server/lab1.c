/*
 * $Id: lab1.c,v 1.2 2007/10/24 11:38:38 devel Exp $
 *
 * $Log: lab1.c,v $
 * Revision 1.2  2007/10/24 11:38:38  devel
 * must carry deathfibrin stuff to use it
 *
 */
...
// todo: make deathfibrin visible in the dark
// todo: make item dropable, but takeable only by it's first owner
