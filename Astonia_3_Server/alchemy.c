/*
 * $Id: alchemy.c,v 1.2 2006/04/26 16:05:44 ssim Exp $
 *
 * $Log: alchemy.c,v $
...
int mixer_power(int in,int cn)
{
	...
	if (cnt==2 && pw1==1 && pw2==1) {
		if (solstice || (fullmoon && ch[cn].prof[P_ALCHEMIST]>=30) || ch[cn].prof[P_ALCHEMIST]>=50) return 16;
		if (equinox || (fullmoon && ch[cn].prof[P_ALCHEMIST]>=20) || ch[cn].prof[P_ALCHEMIST]>=40) return 12;
		if (fullmoon || stone || ch[cn].prof[P_ALCHEMIST]>=10) return 10;
	}
	if (cnt==2 && pw2==1 && pw3==1) {
		if (solstice || (fullmoon && ch[cn].prof[P_ALCHEMIST]>=30) || ch[cn].prof[P_ALCHEMIST]>=50) return 24;
		if (equinox || (fullmoon && ch[cn].prof[P_ALCHEMIST]>=20) || ch[cn].prof[P_ALCHEMIST]>=40) return 20;
		if (fullmoon || stone || ch[cn].prof[P_ALCHEMIST]>=10) return 16;		
	}
	if (cnt==2 && pw3==1 && pw4==1) {
		if (solstice || (fullmoon && ch[cn].prof[P_ALCHEMIST]>=30) || ch[cn].prof[P_ALCHEMIST]>=50) return 32;
		if (equinox || (fullmoon && ch[cn].prof[P_ALCHEMIST]>=20) || ch[cn].prof[P_ALCHEMIST]>=40) return 26;
		if (fullmoon || stone || ch[cn].prof[P_ALCHEMIST]>=10) return 20;
	}
	if (cnt==2 && pw4==1 && pw5==1) {
		if (solstice || (fullmoon && ch[cn].prof[P_ALCHEMIST]>=30) || ch[cn].prof[P_ALCHEMIST]>=50) return 40;
		if (equinox || (fullmoon && ch[cn].prof[P_ALCHEMIST]>=20) || ch[cn].prof[P_ALCHEMIST]>=40) return 32;
		if (fullmoon || stone || ch[cn].prof[P_ALCHEMIST]>=10) return 24;
	}
	if (cnt==2 && pw5==1 && pw6==1) {
		if (solstice || (fullmoon && ch[cn].prof[P_ALCHEMIST]>=30) || ch[cn].prof[P_ALCHEMIST]>=50) return 48;
		if (equinox || (fullmoon && ch[cn].prof[P_ALCHEMIST]>=20) || ch[cn].prof[P_ALCHEMIST]>=40) return 38;
		if (fullmoon || stone || ch[cn].prof[P_ALCHEMIST]>=10) return 28;
	}
	if (cnt==2 && pw6==1 && pw7==1) {
		if (solstice || (fullmoon && ch[cn].prof[P_ALCHEMIST]>=30) || ch[cn].prof[P_ALCHEMIST]>=50) return 56;
		if (equinox || (fullmoon && ch[cn].prof[P_ALCHEMIST]>=20) || ch[cn].prof[P_ALCHEMIST]>=40) return 44;
		if (fullmoon || stone || ch[cn].prof[P_ALCHEMIST]>=10) return 32;
	}
	if (cnt==2 && pw7==1 && pw8==1) {
		if (solstice || (fullmoon && ch[cn].prof[P_ALCHEMIST]>=30) || ch[cn].prof[P_ALCHEMIST]>=50) return 64;
		if (equinox || (fullmoon && ch[cn].prof[P_ALCHEMIST]>=20) || ch[cn].prof[P_ALCHEMIST]>=40) return 50;
		if (fullmoon || stone || ch[cn].prof[P_ALCHEMIST]>=10) return 36;
	}
	if (cnt==2 && pw8==1 && pw9==1) {
		if (solstice || (fullmoon && ch[cn].prof[P_ALCHEMIST]>=30) || ch[cn].prof[P_ALCHEMIST]>=50) return 72;
		if (equinox || (fullmoon && ch[cn].prof[P_ALCHEMIST]>=20) || ch[cn].prof[P_ALCHEMIST]>=40) return 56;
		if (fullmoon || stone || ch[cn].prof[P_ALCHEMIST]>=10) return 40;
	}

	if (solstice || (fullmoon && ch[cn].prof[P_ALCHEMIST]>=30) || ch[cn].prof[P_ALCHEMIST]>=50) good=8;
	else if (equinox || (fullmoon && ch[cn].prof[P_ALCHEMIST]>=20) || ch[cn].prof[P_ALCHEMIST]>=40) good=4;
	else if (fullmoon || ch[cn].prof[P_ALCHEMIST]>=10) good=2;
...
int mixer_mix(int cn,int in,int power,int duration,double divi)
{
	...
	power+=ice*8;
	power+=hell*12;
	if (ch[cn].prof[P_ALCHEMIST]>=20) power+=4;
	if (ch[cn].prof[P_ALCHEMIST]>=30) power+=4;
	if (ch[cn].prof[P_ALCHEMIST]>=40) power+=4;
	if (ch[cn].prof[P_ALCHEMIST]>=50) power+=4;
		...
		skl[2]=V_IMMUNITY; val[2]=power/divi/4;
		value=10;
	} else if (cnt==5 && inu==1 && lfe==2 && spr==1 && end==1) {	// flash magic-shield pulse
		skl[0]=V_FLASH; if ((val[0]=power/divi/4)) flag=1;
		skl[1]=V_MAGICSHIELD; val[1]=power/divi/4;
		skl[2]=V_PULSE; val[2]=power/divi/4;
		value=10;
	} else if (cnt==5 && str==1 && lfe==2 && spr==1 && end==1) {	// fire magic-shield pulse
		skl[0]=V_FIRE; if ((val[0]=power/divi/4)) flag=1;
		skl[1]=V_MAGICSHIELD; val[1]=power/divi/4;
		skl[2]=V_PULSE; val[2]=power/divi/4;
		value=10;
	} else if (cnt==5 && inu==1 && str==2 && spr==1 && end==1) {	// flash immunity pulse
		skl[0]=V_FLASH; if ((val[0]=power/divi/4)) flag=1;
		skl[1]=V_IMMUNITY; val[1]=power/divi/4;
		skl[2]=V_PULSE; val[2]=power/divi/4;
		value=10;
	} else if (cnt==5 && str==3 && spr==1 && end==1) {		// fire immunity pulse
		skl[0]=V_FIRE; if ((val[0]=power/divi/4)) flag=1;
		skl[1]=V_IMMUNITY; val[1]=power/divi/4;
		skl[2]=V_PULSE; val[2]=power/divi/4;
		value=10;
		...
		skl[2]=-1; val[2]=0;
		value=8;
	} else if (cnt==3 && str==2 && end==1) {			// pulse
		skl[0]=V_PULSE; if ((val[0]=power/divi/2)) flag=1;
		skl[1]=-1; val[1]=0;
		skl[2]=-1; val[2]=0;
		value=3;
		...
		skl[2]=-1; val[2]=0;
		value=3;
	} else if (cnt==3 && agi==2 && lfe==1) {			// body control
		skl[0]=V_BODYCONTROL; if ((val[0]=power/divi/2)) flag=1;
		skl[1]=-1; val[1]=0;
		skl[2]=-1; val[2]=0;
		value=3;
		...
		skl[0]=V_FIREBALL; if ((val[0]=power/divi/2)) flag=1;
		skl[1]=-1; val[1]=0;
		skl[2]=-1; val[2]=0;
		value=3;
		...
		for (n=0; n<3; n++) {
			...
			if (end) { skl[n]=V_ENDURANCE; if ((val[n]=power*end/divi/cnt)) flag=1; end=0; continue; }
			skl[n]=-1; val[n]=0;
		}
		value=1;
	} else {
