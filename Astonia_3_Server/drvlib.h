 ...
 *
 * $Log: drvlib.h,v $
 * Revision 1.13  2008/03/24 11:23:56  devel
 * arkhata
 *
 * Revision 1.12  2007/12/10 10:13:11  devel
 * added carlos quest
 *
 * Revision 1.11  2007/06/22 12:59:08  devel
 * added caligar
 *
 * Revision 1.10  2007/05/26 13:21:02  devel
 * added caligar stuff
 *
...
#define IDR_ORBSPAWN		84	// base: create the above
...
#define IDR_BEYONDPOTION	133	// beyond max mod potion driver
...
//#define IDR_GENERIC_COLLECTION1 189     // generic items (lolli)
...
#define IDR_DONTSAVE(a)	((a)==IDR_CURSE || (a)==IDR_MELTINGKEY || (a)==IDR_BACKTOFIRE || (a)==IDR_PALACEBOMB || (a)==IDR_PALACECAP)
