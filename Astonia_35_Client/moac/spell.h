...
#define MAGICSHIELDCOST	magic shield cost is variable (quarter of the shield value)
#define FLASHCOST	(3*POWERSCALE)
#define FIREBALLCOST	(2*POWERSCALE)
#define BALLCOST	(3*POWERSCALE)
#define PULSECOST	pulse cost is variable (skill/4)

#define WARCRYCOST	warcry does not have a cost
